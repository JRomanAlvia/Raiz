...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-04-2015 a las 03:52:56
...
CREATE TABLE IF NOT EXISTS `catastrofes` (
  ...
  `Plantas_pestes_id` int(11) NOT NULL,
  `imagen` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_Catastrofes_Cultivo1_idx` (`Cultivo_id`),
  KEY `fk_Catastrofes_Plantas_pestes1_idx` (`Plantas_pestes_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `cultivo` (
  ...
  `area_cultivo` varchar(45) DEFAULT NULL,
  `tipo_medida` varchar(45) DEFAULT NULL,
  `num_planta` varchar(45) DEFAULT NULL,
  `cantidad_cosecha` decimal(9,2) DEFAULT NULL,
  ...
  KEY `fk_Cultivo_Usuarios1_idx` (`Usuarios_id`),
  KEY `fk_Cultivo_Plantas1_idx` (`Plantas_id`),
  KEY `fk_Cultivo_City1_idx` (`City_id`)
...
INSERT INTO `cultivo` (`id`, `longitud`, `latitud`, `fecha_inicio`, `area_cultivo`, `tipo_medida`, `num_planta`, `cantidad_cosecha`, `estado`, `Usuarios_id`, `Plantas_id`, `City_id`) VALUES
(1, '-0.184306', '-78.485116', '12/04/2015', '1', '1', '1', '1.00', '1', 1, 1, 594);
...
CREATE TABLE IF NOT EXISTS `detalle_catalogo` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Detalle_Catalogo_Catalogo1_idx` (`Catalogo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `notas` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Notas_tablas1_idx` (`tablas_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
INSERT INTO `notas` (`id`, `comentario`, `tablas_id`) VALUES
(1, 'Son Pezticidas', 2);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pestes`
--

CREATE TABLE IF NOT EXISTS `pestes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) DEFAULT NULL,
  `tipo_peste` varchar(45) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `pestes`
--

INSERT INTO `pestes` (`id`, `nombre`, `tipo_peste`, `nombre_cientifico`, `imagen`, `estado`) VALUES
(1, 'Agalla', 'Insecto', 'Trioza ancep', 'http://biocontrol.ucr.edu/hoddle/trioza/lateral_view_of_trioza_galls.JPG', 'S'),
(2, 'Arania roja', 'Insecto', 'Bryobia praetiosas', 'http://upload.wikimedia.org/wikipedia/commons/5/55/Bryobia_praetiosa_Koch.jpg', 'S'),
(3, 'Arania roja', 'Insecto', 'Paratetranychus', 'http://www.cenicafe.org/es/documents/aranitaRoja2.png', 'S'),
(4, 'Arania roja', 'Insecto', 'Paratetranychus stickney', 'http://azu1.facilisimo.com/ima/i/1/b/c8/412_79225_6613847_154760.jpg', 'S'),
(5, 'Arania roja', 'Insecto', 'Bryobia praetiosas', 'http://upload.wikimedia.org/wikipedia/commons/5/55/Bryobia_praetiosa_Koch.jpg', 'S'),
(6, 'Arania roja', 'Insecto', 'Paratetranychus', 'http://www.cenicafe.org/es/documents/aranitaRoja2.png', 'S'),
(7, 'Arania roja', 'Insecto', 'Paratetranychus stickney', 'http://azu1.facilisimo.com/ima/i/1/b/c8/412_79225_6613847_154760.jpg', 'S'),
(8, 'Arania roja', 'Insecto', 'Bryobia praetiosas', 'http://upload.wikimedia.org/wikipedia/commons/5/55/Bryobia_praetiosa_Koch.jpg', 'S'),
(9, 'Arania roja', 'Insecto', 'Paratetranychus', 'http://www.cenicafe.org/es/documents/aranitaRoja2.png', 'S'),
(10, 'Arania roja', 'Insecto', 'Paratetranychus stickney', 'http://azu1.facilisimo.com/ima/i/1/b/c8/412_79225_6613847_154760.jpg', 'S'),
(11, 'Arania roja', 'Insecto', 'Paratetranychus mexicacanus', 'http://www.jardineria.pro/wp-content/uploads/2012/10/Como-eliminar-plagas-Araña-roja-Tetranychus-urticae.jpg', 'S'),
(12, 'Barrenador', 'Insecto', 'Aegeria exitiosa', 'http://bugguide.net/images/cache/GRS/HER/GRSHERKHQROL3LWLZZELRZUL7ZHH5RCLHZ6LYL2L7RJZRZELKZCL7ZZHERJZIRQH6RFZ6RLHQR2L7RSH4RQHQZQHIZ.jpg', 'S'),
(13, 'Barrenador', 'Insecto', 'Corthylus nudus', 'http://www.coleoptera-neotropical.org/paginas/3ac_familias/CURCULIONOIDEA/0banner/Scolytinae/Xyleborini/xyleborinus-xaseseni.jpg', 'S'),
(14, 'Barrenador', 'Insecto', 'Cyllene erithropa', 'http://www.bio-nica.info/Ento/Coleo/Cerambycidae_archivos/image009.jpg', 'S'),
(15, 'Barrenador', 'Insecto', 'Chrysobotris', 'http://www.biolib.cz/IMG/GAL/160961.jpg', 'S'),
(16, 'Barrenador', 'Insecto', 'Dendrubias manibula', 'http://www.texasento.net/mandibularis2.jpg', 'S'),
(17, 'Barrenador', 'Insecto', 'Diatraea saccharalis', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJ4aXfWLcwDQ6Z6ilmS1DT0oNPaF0MsndanZKaQ5oT0Hwje60oJd-qhvk', 'S'),
(18, 'Barrenador', 'Insecto', 'Lepturges', 'http://bugguide.net/images/cache/XZCLKZOLYLKHSRTZ5RSHGRHH0R3Z6R3ZZZYZHZYZHZPLYLEL7R6L3LWLKRWLIZOL0Z2L7R9LMRTZFLPLLZULSRWLHZ.jpg', 'S'),
(19, 'Barrenador', 'Insecto', 'Onciders cingulata', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTwkrmBpeu_XvlqWxkS1-TzvLYKnbWwvqT7X1yPdX01e8PGgGFEDyb8rI', 'S'),
(20, 'Barrenador', 'Insecto', 'Xyleborus', 'http://behav.zoology.unibe.ch/sysuif/uploads/files/Bild_in_methodenpr__sentation.ppt.jpg', 'S'),
(21, 'Barrenador', 'Insecto', 'Zeadiatraea', 'http://www.fyo.com/sites/default/files/screenhunter_91_feb._27_11.07.jpg', 'S'),
(22, 'Barrenador', 'Insecto', 'Zeadiatraea gradiosella', 'http://www.pregonagropecuario.com/assets/images/upload/Heliothis_zea.jpg', 'S'),
(23, 'Barrenador', 'Insecto', 'Zeadiatraea muellerella', 'http://idtools.org/id/leps/lepintercept/images/large/lineolata1.jpg', 'S'),
(24, 'Barrenador del hueso', 'Insecto', 'Conotrachelus aguacatae', 'url', 'S'),
(25, 'Barrenador del hueso', 'Insecto', 'Helipus lauri', 'url', 'S'),
(26, 'Barrenador del tromco y ramas', 'Insecto', 'Copturus aguacatae', 'url', 'S'),
(27, 'Barrenador o mosca de rabano', 'Insecto', 'Hylemya', 'url', 'S'),
(28, 'Bellotero', 'Insecto', 'Heliothis zea', 'url', 'S'),
(29, 'Conchuela', 'Insecto', 'Epilachna varivestis', 'url', 'S'),
(30, 'Cortador', 'Insecto', 'No identificado', 'url', 'S'),
(31, 'Chapulin', 'Insecto', 'Melanoplus', 'url', 'S'),
(32, 'Chapulin', 'Insecto', 'Heliastus sumichrasti', 'url', 'S'),
(33, 'Chapulin', 'Insecto', 'Pyrgocorypha unicinta', 'url', 'S'),
(34, 'Chapulin', 'Insecto', 'Sphenarium purpurascens', 'url', 'S'),
(35, 'Chinche', 'Insecto', 'Dicyphus minimus ', 'url', 'S'),
(36, 'Chinche', 'Insecto', 'Lygus', 'url', 'S'),
(37, 'Chinche', 'Insecto', 'Lygus lineolaris', 'url', 'S'),
(38, 'Chinche', 'Insecto', 'Chlorochroa ligata', 'url', 'S'),
(39, 'Chinche', 'Insecto', 'Mormidea angustata', 'url', 'S'),
(40, 'Chinche arlequin', 'Insecto', 'Murgantia histrionica', 'url', 'S'),
(41, 'Chinche cafe', 'Insecto', 'Largus succintus', 'url', 'S'),
(42, 'Chicharrita', 'Insecto', 'Agallia barretti', 'url', 'S'),
(43, 'Chicharrita', 'Insecto', 'Chlorotettis emarginalis', 'url', 'S'),
(44, 'Chicharrita', 'Insecto', 'Dalbubus', 'url', 'S'),
(45, 'Chicharrita', 'Insecto', 'Dalbubus elimatus', 'url', 'S'),
(46, 'Chicharrita', 'Insecto', 'Draeculacephala minerva', 'url', 'S'),
(47, 'Chicharrita', 'Insecto', 'Empoasca', 'url', 'S'),
(48, 'Chicharrita', 'Insecto', 'Empoasca Krasmeri', 'url', 'S'),
(49, 'Chicharrita', 'Insecto', 'Empoasca fabae', 'url', 'S'),
(50, 'Chicharrita', 'Insecto', 'Empoasca abrupta', 'url', 'S'),
(51, 'Chicharrita', 'Insecto', 'Emposca mexana', 'url', 'S'),
(52, 'Chicharrita', 'Insecto', 'Emposca phaseala', 'url', 'S'),
(53, 'Chicharrita', 'Insecto', 'Sogata', 'url', 'S'),
(54, 'Diabrotica', 'Insecto', 'Diabrotica Balteata', 'url', 'S'),
(55, 'Diabrotica o doradilla', 'Insecto', 'Cerotoma rutivornis', 'url', 'S'),
(56, 'Diabrotica o doradilla', 'Insecto', 'Diabrotica spp', 'url', 'S'),
(57, 'Diabrotica o doradilla', 'Insecto', 'Diabrotica undecimopunctata howardi', 'url', 'S'),
(58, 'Diabrotica o doradilla', 'Insecto', 'Diabrotica longicornis longicornis', 'url', 'S'),
(59, 'Doradilla o gorgojo', 'Insecto', 'Trobolium', 'url', 'S'),
(60, 'Falso medidor', 'Insecto', 'Trichoplusia ni', 'url', 'S'),
(61, 'Frailecillo', 'Insecto', 'Macrodactylus Mexicanos', 'url', 'S'),
(62, 'Frailecillo', 'Insecto', 'Macrodactylus nigripis', 'url', 'S'),
(63, 'Frailecillo', 'Insecto', 'Macrodactylus', 'url', 'S'),
(64, 'Gallina ciega', 'Insecto', 'Phyllophaga', 'url', 'S'),
(65, 'Gorgojo', 'Insecto', 'Prostephanus truncatus', 'url', 'S'),
(66, 'Gorgojo o doradillas', 'Insecto', 'Tribolium', 'url', 'S'),
(67, 'Gusano', 'Insecto', 'No identificado', 'url', 'S'),
(68, 'Gusano', 'Insecto', 'Colias', 'url', 'S'),
(69, 'Gusano', 'Insecto', 'Trichoplusia ni', 'url', 'S'),
(70, 'Gusano alfiler', 'Insecto', 'Keiferia licopersicella', 'url', 'S'),
(71, 'Gusano cogollero', 'Insecto', 'Spodoptera frugiperda', 'url', 'S'),
(72, 'Gusano cuerno', 'Insecto', 'Protoparce', 'url', 'S'),
(73, 'Gusano elotero', 'Insecto', 'Heliothis zea', 'url', 'S'),
(74, 'Gusano del fruto', 'Insecto', 'Heliothis zea', 'url', 'S'),
(75, 'Gusano quelitero', 'Insecto', 'Spodoptera exigua', 'url', 'S'),
(76, 'Gusano telaraniero', 'Insecto', 'No identificado', 'url', 'S'),
(77, 'Larva o gusano', 'Insecto', 'Colias eurytheme', 'url', 'S'),
(78, 'Larva o gusano', 'Insecto', 'Leucochlaena hipparis', 'url', 'S'),
(79, 'Larva o gusano', 'Insecto', 'Spodoptera frugiperda', 'url', 'S'),
(80, 'Mayate o escarabajo', 'Insecto', 'Euphoria basalis', 'url', 'S'),
(81, 'Mayate prieto', 'Insecto', 'Rhynchophorus palmarum', 'url', 'S'),
(82, 'Minador', 'Insecto', 'Liriomyza sp', 'url', 'S'),
(83, 'Minador', 'Insecto', 'Xenochalepus signaticailis', 'url', 'S'),
(84, 'Mosca Blanca', 'Insecto', 'Traileurodes', 'url', 'S'),
(85, 'Mosca blanca', 'Insecto', 'Traileurodes vaporariorum', 'url', 'S'),
(86, 'Mosquilla blanca', 'Insecto', 'Tetraleurodes acaciae', 'url', 'S'),
(87, 'Mosquilla blanca', 'Insecto', 'Trialeuodes vaporariorum', 'url', 'S'),
(88, 'Mosquilla blanca', 'Insecto', 'trialeurodes', 'url', 'S'),
(89, 'Mosca de la fruta', 'Insecto', 'Anastrepha fraterculus', 'url', 'S'),
(90, 'Mosca de la fruta', 'Insecto', 'Anastrepha', 'url', 'S'),
(91, 'Mosca de la papaya', 'Insecto', 'Toxtripana curvicauda', 'url', 'S'),
(92, 'Mosca pinta', 'Insecto', 'Aenolamia', 'url', 'S'),
(93, 'Mosca Prieta', 'Insecto', 'Aleurocathus woglumi', 'url', 'S'),
(94, 'Mosca del rabano', 'Insecto', 'Hylemya', 'url', 'S'),
(95, 'Mosca de la semilla', 'Insecto', 'Hylemya cilicruca', 'url', 'S'),
(96, 'Palomilla', 'Insecto', 'Gnorimoschema operculella', 'url', 'S'),
(97, 'Palomilla blanca', 'Insecto', 'Rupela albinella', 'url', 'S'),
(98, 'Palomilla de la manzana', 'Insecto', 'Carpocapsa pomonella', 'url', 'S'),
(99, 'Periquito', 'Insecto', 'Metcalfiella monogramama', 'url', 'S'),
(100, 'Periquito', 'Insecto', 'Antianthe foliacea', 'url', 'S'),
(101, 'Periquito', 'Insecto', 'Spissistilus femoratus', 'url', 'S'),
(102, 'Periquito', 'Insecto', 'Lema abrupta', 'url', 'S'),
(103, 'Periquito', 'Insecto', 'Spissistilus', 'url', 'S'),
(104, 'Periquito', 'Insecto', 'Stictocephala', 'url', 'S'),
(105, 'Picudo', 'Insecto', 'Anthonomus eugenil', 'url', 'S'),
(106, 'Picudo', 'Insecto', 'Anthonomus grandis', 'url', 'S'),
(107, 'Picudo', 'Insecto', 'Apion aequabike', 'url', 'S'),
(108, 'Picudo', 'Insecto', 'Apion aurichalceum', 'url', 'S'),
(109, 'Picudo', 'Insecto', 'Apion godmani', 'url', 'S'),
(110, 'Picudo', 'Insecto', 'Apion plectyoculum', 'url', 'S'),
(111, 'Picudo', 'Insecto', 'Epicaerus aurifer', 'url', 'S'),
(112, 'Picudo', 'Insecto', 'Epicaerus cognatus', 'url', 'S'),
(113, 'Picudo', 'Insecto', 'Gereaus senilis', 'url', 'S'),
(114, 'Picudo', 'Insecto', 'Macrodactylus nigripes', 'url', 'S'),
(115, 'Picudo', 'Insecto', 'Sitophylus oryzo', 'url', 'S'),
(116, 'Picudo acuatico', 'Insecto', 'Lissorhoptrus oryzaphilus', 'url', 'S'),
(117, 'Picudo del fruto', 'Insecto', 'Conotrachelus dimidiatus', 'url', 'S'),
(118, 'Psilido', 'Insecto', 'Paratrioza cockerelli', 'url', 'S'),
(119, 'Pulga negra', 'Insecto', 'Chaetocnema', 'url', 'S'),
(120, 'Pulga negra', 'Insecto', 'Epitrix o Chaetocnema', 'url', 'S'),
(121, 'Pulgon verde', 'Insecto', 'Acyrthosiphum pisum', 'url', 'S'),
(122, 'Pulgon', 'Insecto', 'Mysus persiacae', 'url', 'S'),
(123, 'Pulgon', 'Insecto', 'Aphis gossypii', 'url', 'S'),
(124, 'Pulgon', 'Insecto', 'Brevicoryne brassicae', 'url', 'S'),
(125, 'Pulgon', 'Insecto', 'Eriosoma lanigerum', 'url', 'S'),
(126, 'Pulgon', 'Insecto', 'Macrosiphum avenae', 'url', 'S'),
(127, 'Pulgon', 'Insecto', 'Schizaphis gramainum', 'url', 'S'),
(128, 'Pulgon', 'Insecto', 'Myzus persicae', 'url', 'S'),
(129, 'Pulgon', 'Insecto', 'No identificado', 'url', 'S'),
(130, 'Pulgon', 'Insecto', 'Rhopalosiphum maidis', 'url', 'S'),
(131, 'Pulgon manchado', 'Insecto', 'Therioaphis maculatus', 'url', 'S'),
(132, 'Trip', 'Insecto', 'Frankliniella fortisima', 'url', 'S'),
(133, 'Trip', 'Insecto', 'Frankliniella minuta', 'url', 'S'),
(134, 'Trip', 'Insecto', 'Frankliniella obscurus', 'url', 'S'),
(135, 'Trip', 'Insecto', 'Frankliniella occidentalis', 'url', 'S'),
(136, 'Trip', 'Insecto', 'Frankliniella mexicanus', 'url', 'S'),
(137, 'Trip', 'Insecto', 'Frankliniella williamsi', 'url', 'S'),
(138, 'Trip', 'Insecto', 'Aeliothrip mayor', 'url', 'S'),
(139, 'Trip', 'Insecto', 'Frankliniella', 'url', 'S');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pesticidas`
--

CREATE TABLE IF NOT EXISTS `pesticidas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(45) DEFAULT NULL,
  `descripcion_formula` varchar(45) DEFAULT NULL,
  `tipo_pesticidas` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=261 ;

--
-- Volcado de datos para la tabla `pesticidas`
--

INSERT INTO `pesticidas` (`id`, `descripcion`, `descripcion_formula`, `tipo_pesticidas`) VALUES
(1, 'Prueba', 'Prueba Formularss', 'Prueba'),
(2, 'Tridecen il acetato', 'C15H28O2', 'Feromona atrayente'),
(3, 'Dodecadien', 'C12H22O2', 'Alifatico atrayente'),
(4, 'Dicloropropeno (USO RESTRINGIDO)', 'C3H4Cl2', 'Organocorado fumigante ''nematicida'''),
(5, 'Acido 2,4 Diclorofenoxiacetico', 'C8H6O3Cl2', 'Clorofenoxi herbicida'),
(6, 'Acido diclorofenox butirico', 'C10H10O3Cl2', 'Clorofenoxi herbicida'),
(7, 'Abamectina', 'C48H72O14(B1a) C47H70O14(B1b', 'Pentaciclina insecticida acaricida'),
(8, 'Acefate (dimetil acetilfosforoamindotioato', 'C4H10NO3PS', 'Insecticida'),
(9, 'Actoclor', 'C14H20NO2Cl', 'Herbicida'),
(10, 'Acido borico', 'H3BO3', 'Insecticida'),
(11, 'Alaclor', 'C14H20O2NCl', 'Herbicida'),
(12, 'Aldicarb ''USO RESTRINGIDO''', 'C7H14O2N2S', 'Insecticida nematicida'),
(13, 'Aletrina', 'C19H26O3', 'Insecticida'),
(14, 'Ametrina', 'C9H17N5S', 'Herbicida'),
(15, 'Amitraz', 'C19H23N3', 'Acaricida'),
(16, 'Anilazina', 'C9H5Cl3N4', 'Fungicida'),
(17, 'Asulam', 'C8H10N2O4S', 'Herbicida'),
(18, 'Atrazina', 'C8H14ClN5', 'Herbicida'),
(19, 'Azadiractina', 'C33H42O13', 'Insecticida'),
(20, 'Azinfos metilico', 'C10H12N3O3PS2', 'Insecticida'),
(21, 'Bacilllus thuringiensis', 'No Especificado', 'Insecticida'),
(22, 'Beauveria bassiana', 'No Especificado', 'Insecticida'),
(23, 'Bendiocarb', 'C11H13NO4', 'Insecticida'),
(24, 'Benomilo', 'C14H18O3N4', 'Fungicida'),
(25, 'Bensulide', 'C14H24NO4PS3', 'Herbicida'),
(26, 'Bentazon', 'C10H12N2O3S', 'Herbicida'),
(27, 'Bifentrina', 'C23H20O2ClF3', 'Insecticida y acaricida'),
(28, 'Bioaletrina', 'C19H26O3', 'Insecticida'),
(29, 'Bioresmetrina', 'C22H26O3', 'Insecticida'),
(30, 'Bitertanol', 'C20H23N3O2', 'Fungicida'),
(31, 'Borax', 'B4O7Na10(H2O)', 'Insecticida'),
(32, 'Brodifacoum', 'C31H23BrO3', 'Rodenticida'),
(33, 'Bromacil', 'C9H13BrN2O2', 'Herbicida'),
(34, 'Bromadiolona', 'C30H23BrO4', 'Rodenticida'),
(35, 'Bromoxinil', 'C7H3Br2NO', 'Herbicida'),
(36, 'Bromuconazole', 'C13H12BrCl2N3O', 'Fungicida'),
(37, 'Bromuro de metilo', 'CH3Br', 'Fumigante'),
(38, 'Cadusafos', 'C10H23O2PS2', 'Nematicida insecticida'),
(39, 'Captafol', 'C10H9Cl4NO2S', 'Fungicida'),
(40, 'Captan', 'C9H8Cl3NO2S', 'Fungicida'),
(42, 'Carbarilo', 'C12H11NO2', 'Insecticida acaricida'),
(43, 'Carbendazim', 'C9H9N3O2', 'Fungicida'),
(44, 'Carbofuran', 'C12H15NO3', 'Insecticida nematicida'),
(45, 'Carboxin', 'C12H13O2NS', 'Fungicida'),
(46, 'Cifenotrina', 'C24H25NO3', 'Insecticida'),
(47, 'Cipermetrina', 'C22H19Cl2NO3', 'Insecticida acaricida'),
(48, 'Alfa cipermetrina', 'C22H19Cl2NO3', 'Insecticida acaricida'),
(49, 'Clethodim', 'C17H26O3ClS', 'Herbicida'),
(50, 'Clofentezine', 'C14H8C12N4', 'Acaricida'),
(51, 'Clomazone', 'C12H14ClNO2', 'Herbicida'),
(52, 'Clordano PROHIBIDO', 'C10H6Cl8', 'Insecticida'),
(53, 'Clorfenvinfos', 'C12H14Cl3O4P', 'Insecticida'),
(54, 'Clorhidrato de formetanato', 'C11H15N3O2HCl', 'Insecticida'),
(55, 'Clorofacinona', 'C23H15ClO3', 'Rodentica'),
(56, 'Cloropicrina', 'CCl3NO2', 'Fumigante'),
(57, 'Clorotalonil', 'C8Cl4N2', 'Fungicida'),
(58, 'Clorpirifos etil', 'C9H11Cl3NO3PS', 'Insecticida'),
(59, 'Clorpirifos metil', 'C7H7Cl3NO3PS', 'Insecticida'),
(60, 'Clortal dimetil DCPA', 'C8H4O4Cl4', 'Herbicida'),
(61, 'Cloruro de benzalconio', 'C9H13NRCl', 'Fungicida bactericida'),
(62, 'Coumafos', 'C14H16ClO5PS', 'Inseticida acaricida'),
(63, 'Coumatetralil', 'C19H16O3', 'Rodenticida'),
(64, 'Cyflutrin', 'C22H18ClFNO3', 'Identicida'),
(65, 'Betacyflutrin', 'C22H18Cl2FNO3', 'Insecticida'),
(66, 'Cyproconazole', 'C15H18ClN3O', 'Fungicida'),
(67, 'Dazomet', 'C5H10N2S2', 'Fungicida bactericida'),
(68, 'DBNPA', 'C3H2Br2N2O', 'Fungicida'),
(69, 'Deltametrina', 'C22H19Br2NO3', 'Insecticida'),
(70, 'Diazinon', 'C12H21N2O3PS', 'Insecticida acaricida'),
(71, 'Diclofop metil', 'C16H14Cl2O4', 'Herbicida'),
(72, 'Dicloran', 'C6H4Cl2N2O2', 'Fungicida'),
(73, 'Diclorvos', 'C4H7Cl2O4P', 'Insecticida'),
(74, 'Dicofol USO RESTRINGIDO', 'C14H9Cl5O', 'Acaricida'),
(75, 'Difacinona', 'C23H16O3', 'Rodenticida'),
(76, 'Difenoconazole', 'C19H17Cl2N3O3', 'Fungicida'),
(77, 'Diflubenzuron', 'C14H9ClF2N2O2', 'Insecticida'),
(78, 'Dimetipin', 'C6H10O4S2', 'Herbicida'),
(79, 'Dimetoato', 'C5H12NO3PS2', 'Insecticida'),
(80, 'Dinocap', 'C18H24O6N2', 'Fungicida'),
(81, 'Diquat', 'C12H12Br2N2', 'Herbicida'),
(82, 'Disulfoton', 'C8H19O2PS3', 'Insecticida acaricida'),
(83, 'Diuron', 'C9H10ON2Cl2', 'Herbicida'),
(84, 'Endosulfan', 'C9H6Cl6O3S', 'Insecticida acaricida'),
(85, 'EPTC', 'C9H19O2SCN', 'Herbicida'),
(86, 'Esbioaetrina', 'C19H26O3', 'Herbicida'),
(87, 'Esfenvalerato', 'C25H22ClNO3', 'Insecticida'),
(88, 'Estreptomicina', 'C42H78N14O24H6', 'Bactericida'),
(89, 'Etalfluralina', 'C13H14F3N3O4', 'Herbicida'),
(90, 'Etoprofos', 'C8H19O2PS2', 'Insecticida nematicida'),
(91, 'Etridiazol', 'C5H5ON2Cl3S', 'Fungicida'),
(92, 'Fenamifos', 'C13H22NO3PS', 'Nematicida'),
(93, 'Fenarimol', 'C17H12Cl2N2O', 'Fungicida'),
(94, 'Fenbuconazole', 'C19H17ClN4', 'Fungicida'),
(95, 'Fenitrotion', 'C9H12NO5PS', 'Insecticida'),
(96, 'Fenotrina', 'C23H26O3', 'Insecticida'),
(97, 'Fenoxaprop etil', 'C18H16ClNO5', 'Herbicida'),
(98, 'Fenoxaprop p etil', 'C18H16ClNO5', 'Herbicida'),
(99, 'Fenpropatrin', 'C22H23NO3', 'Insecticida acaricida'),
(100, 'Fention', 'C10H15PS2', 'Insecticida'),
(101, 'Fentoato', 'C1217O4PS2', 'Insecticida acaricida'),
(102, 'Ferbam', 'C9H18FeN3S6', 'Fungicida'),
(103, 'Fipronil', 'C12H4Cl2F6N4OS', 'Insecticida'),
(104, 'Flocoumafen', 'C33H25F3O4', 'Rodenticida'),
(105, 'Fluazifop p butil', 'C19H20O4NF3', 'Herbicida'),
(106, 'Fluazuron', 'C20Cl2F5N3O3', 'Acaricida'),
(107, 'Flufenoxuron', 'C21H11ClF6N2O3', 'Insecticida acaricida'),
(108, 'Flumetrina', 'C28H22Cl2FNO3', 'Acaricida'),
(109, 'Fluometuron', 'C10H11ON2F3', 'Herbicida'),
(110, 'Fluroxipir meptil', 'C7H5l2FN2O3', 'Herbicida'),
(111, 'Fomesafen', 'C15H10ClF3N2O6S', 'Herbicida'),
(112, 'Fonofos', 'C10H15OPS2', 'Insecticida'),
(113, 'Forato', 'C7H17O2PS3', 'Insecticida'),
(189, 'Fosetil al', 'Al(C2H6O3P)3', 'Fungicida'),
(190, 'Fosfuro de aluminio', 'AlP', 'Fumigante'),
(191, 'Fosfuro de magnesio', 'Mg3P2', 'Fumigante'),
(192, 'Fosmet', 'C11H12NO4PS2', 'Acaricida'),
(193, 'Foxim', 'C12H15N2O3PS', 'Insecticida'),
(194, 'Glifosato', 'C6H17N2O5P', 'Herbicida'),
(195, 'Glifosato trimesium', 'C1232NO5PS3', 'Herbicida'),
(196, 'Glufosinato de amonio', 'C5H15N2O4P', 'Herbicida'),
(197, 'Guazatine', 'C18H14N7', 'Fungicida'),
(198, 'Hexaflumuron', 'C16H8F6N2O3', 'Insecticida'),
(199, 'Hexazinona', 'C12H20N4O2', 'Herbicida'),
(200, 'Hidrametilona', 'C25H24F6N4', 'Insecticida'),
(201, 'Hidroxido cuprico', 'Cu(OH)2', 'Fungicida'),
(202, 'Imazalil', 'C14H14Cl2N2O', 'Fungicida'),
(203, 'Imazethapyr', '15H19N3O3', 'Herbicida'),
(204, 'Imidacloprid', 'C9H10ClN5O2', 'Insecticida'),
(205, 'IPBC', 'C8H12lNO2', 'Fungicida'),
(206, 'Iprodiona', 'C13H13Cl2N3O3', 'Fungicida'),
(207, 'Isofenfos', 'C15H24NO4PS', 'Insecticida'),
(208, 'Lambda cyalotrina', 'C23H19ClF3NO3', 'Insecticida'),
(209, 'Lindano USO RESTRINGIDO', 'C6H6Cl6', 'Insecticida acaricida'),
(210, 'Linuron', 'C9H10ClN2O2', 'Herbicida'),
(211, 'Mancozeb', 'C4H6N2S4MnZn', 'Fungicida'),
(212, 'Maneb', 'C4H6N2S4Mn', 'Fungicida'),
(213, 'Metalaxil', 'C15H21NO4', 'Fungicida'),
(214, 'Metaldehido', 'C8H16O4', 'Molusquicida'),
(215, 'Metam sodio USO RESTRINGIDO', 'C2H4NNaS2', 'Fumigante'),
(216, 'Metamidofos', 'C2H8NO2PS', 'Insecticida acaricida'),
(217, 'Metidation', 'C6H11N2O4PS3', 'Insecticida acaricida'),
(218, 'Metolaclor', 'C15H22O2NCl', 'Herbicida'),
(219, 'Metomilo', 'C5H10N2O2S', 'Insecticida'),
(220, 'Metoprene', 'C19H34O3', 'Insecticida'),
(221, 'Metsulfuron metil', 'C14H15O6N5S', 'Herbicida'),
(222, 'Mevinfos', 'C7H13O6P', 'Insecticida acaricida'),
(223, 'Molinate', 'C9H17NOS', 'Herbicida'),
(224, 'MSMA', 'CH4AsNaO3', 'Herbicida'),
(225, 'Naled', 'C4H7Br2Cl2O4P', 'Insecticida'),
(226, 'Napropamida', 'C17H21NO2', 'Herbicida'),
(227, 'Naptalam', 'C18H13NO3', 'Herbicida'),
(228, 'Nicosulfuron', 'C15H18N6O6S', 'Herbicida'),
(229, 'Norflurazon', 'C12H9ClF3N3O', 'Herbicida'),
(230, 'Ometoato', 'C5H12NO4PS', 'Insecticida acaricida'),
(231, 'Orizalin', 'C12H1N4SO6', 'Herbicida'),
(232, 'Oxadixyl', 'C14H18N2O4', 'Fungicida'),
(233, 'Oxamil', 'C7H13N3O3S', 'Insecticida nematicida acaricida'),
(234, 'Oxicarboxin', 'C12H13NO4S', 'Fungicida'),
(235, 'Oxicloruro de cobre', '3Cu(OH)2CuCl2', 'Fungicida'),
(236, 'Oxidemeton metil', 'C6H15PS2', 'Insecticida acaricida'),
(237, 'Oxido cuproso', 'Cu2O', 'Fungicida'),
(238, 'Oxitetraciclina', 'C22H24N2O9', 'Bactericida'),
(239, 'Paraquat USO RESTRINGIDO', 'C12H14Cl2N2', 'Herbicida desecante'),
(240, 'Pebulato', 'C10H21NOS', 'Herbicida'),
(241, 'Pencycuron', 'C19H21ClN2O', 'Fungicida'),
(242, 'Pentaclorofenol USO RESTRINGIDO', 'C6HCl5O', 'Fungicida bactericida'),
(243, 'Picloram', 'C6H3Cl3N2O2', 'Herbicida'),
(244, 'Pirazofos', 'C14H20N3O5PS', 'Fungicida'),
(245, 'Pirimicarb', 'C11H18N4O2', 'Insecticida'),
(246, 'Pirimifos metil', 'C11H20N3O3PS', 'Insecticida'),
(247, 'Piritiobac sodio', 'C13H10ClN2NaO4', 'Herbicida'),
(248, 'Praletrina', 'C19H24O3', 'Insecticida'),
(249, 'Primisulfuron', 'C15H12F4N4O7S', 'Herbicida'),
(250, 'Procloraz', 'C15H16Cl3N3O2', 'Fungicida'),
(251, 'Profenofos', 'C11H15O3PSBrCl', 'Insecticida'),
(252, 'Prometrina', 'C10H19N5S', 'Herbicida'),
(253, 'Propamocarb clorhidrato', 'C9H21ClN2O2', 'Fungicida'),
(254, 'Propiconazol', 'C15H17Cl2N3O2', 'Fungicida'),
(255, 'Propoxur', 'C11H15NO3', 'Isecticida'),
(256, 'Prosulfuron', 'C15H16F3N5O4S', 'Herbicida'),
(257, 'Pyridaben', 'C19H25ClN2OS', 'Insecticida acaricida'),
(258, 'Quizalofop etil', 'C19H17ClN2O4', 'Herbicida'),
(259, 'Resmetrina', 'C22H26O3', 'Insecticida'),
(260, 'Rimsulfuron', 'C14H17N5O7S2', 'Herbicida');
...
CREATE TABLE IF NOT EXISTS `plantas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(45) DEFAULT NULL,
  `descripcion_cientifica` varchar(45) DEFAULT NULL,
  `tiempo_cocecha` varchar(45) DEFAULT NULL,
  `epoca_anio` varchar(45) DEFAULT NULL,
  `imagen` varchar(200) DEFAULT NULL,
...
INSERT INTO `plantas` (`id`, `descripcion`, `descripcion_cientifica`, `tiempo_cocecha`, `epoca_anio`, `imagen`, `padre_id`) VALUES
(1, 'Prueba', 'Prueba', 'Prueba', '2015', 'Prueba', 1),
(2, 'Acelga', 'Beta vulgaris', '8 semanas', 'Primaver - Otonio', 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQnuU7MVy79o9Rq98OHSTcikYQXEIBd2Fs8r9J0D4GNzaZthU8g', 1),
(3, 'Aji pimiento grande', 'Capsicum annum', '10 semanas', 'Fin invierno', 'http://www.epimundo.com/wp-content/upLoads/aji.JPG', 1),
(4, 'Aji pimiento grande', 'Capsicum annum', '10 semanas', 'Fin invierno', 'http://www.epimundo.com/wp-content/upLoads/aji.JPG', 1),
(5, 'Ajo', 'Allium sativum L', ' meses y medio', 'Primavera -Otoño', 'http://www.alimentacioncanina.com/wp-content/uploads/2012/09/los-perros-pueden-comer-ajo.jpg', 1),
(6, 'Apio', 'Apium gravolens', '5 meses', 'Principios Primavera', 'http://i.ytimg.com/vi/dqpRvNxMeYs/maxresdefault.jpg', 1),
(7, 'Berenjena', 'Solanum meolongena', '2 meses', 'Fin de invierno', 'http://www.agrobio.org/bfiles/art_imgart-787.jpg', 1),
(8, 'Calabaza', 'Curcurbita moschata', '4 meses', 'Primavera', 'http://blog.herbolarionavarro.es/wp-content/uploads/2012/11/Calabaza.jpg', 1),
(9, 'Cebolla', 'Allium cepa', '4 meses', 'Primavera Verano e invierno', 'http://hotelvalonsadero.com/blog/wp-content/uploads/2015/02/cebolla-2.jpg', 1),
(10, 'Col/Repollo', 'Brassica oleracea', '3 a 4.5 meses', 'Multiple temporada', 'http://versveld.com/media/catalog/product/cache/1/thumbnail/9df78eab33525d08d6e5fb8d27136e95/r/e/repollo.jpg', 1),
(11, 'Espinaca', 'Spinacia oleracea', '2 meses', 'Primavera - Otonio', 'http://ejerciciosencasa.es/wp-content/uploads/2013/12/espinacas.jpg', 1),
(12, 'Habichuela / Poroto', 'Phaseolus vulgaris', '60 - 90 dias', 'Primavera', 'http://www.semprecol.com/imagenes/fotosfichashort/habichuela1.jpg', 1),
(13, 'Lechuga', 'Lactuca sativa', '20 - 65 dias', 'Casi todo el anio', 'https://s3-us-west-2.amazonaws.com/synimages/lechuga.jpg', 1),
(14, 'Maiz', 'Zea mays L', '4 a 6 meses', 'Toda la primavera', 'https://missionventureministries.files.wordpress.com/2010/04/29951-corn.jpg', 1),
(15, 'Mani', 'Arachis hypogaea', '4 a 6 meses', 'Primavera', 'http://www.atletas.info/wp-content/uploads/2011/11/01.jpg', 1),
(16, 'Tomate', 'Lycopersicion esculentum', '3 meses', 'Inicio primavera', 'http://sabersalud.com/wp-content/uploads/2013/03/tomates.jpg', 1),
(17, 'Pepino', 'Cucumis sativus', '8 semanas en adelante', 'Primavera', 'http://www.mercacordoba.es/sites/default/files/pepino.jpg', 1),
(18, 'Rabano / Rabanito', 'Raphanus sativus', '6 semanas', 'Primavera, verano e otonio', 'http://www.hola.com/imagenes/cocina/recetas/2012070959594/recetas-ensaladas-rabano/0-209-502/recetas_rabano_-z.jpg', 1),
(19, 'Remolacha', 'Beta vulgaris', '60 a 120 dias', 'Fin de primavera', 'http://elhortal.webcindario.com/imag/remilachagd.jpg', 1),
(20, 'Zanahoria', 'Daucus carota', '2 a 3 semanas', 'Primavera, otonio e invierno', 'http://static.hogarutil.com/archivos/201205/zanahorias-buenas-vista-xl-668x400x80xX.jpg', 1),
(21, 'Aguacate / Palta / Abacate', 'Persea auericana', '5 a 7 meses', 'Multiple temporada', 'http://www.mujerhoy.com/pic.aspx?w=651&h=366&img=aguacate_beneficios2012522261.jpg', 1),
(22, 'Papaya / Fruta Bomba', 'Carica papaya', '8 - 12 meses', 'Verano - Invierno', 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQidiBIbn_EUQVZGFwJ-KGvV95h5h8QlcjE5Dzd1kqmSByzZmN8', 1),
(23, 'Guanabana', 'Annona muricate', '1.8 a 2 anios', 'Verano - Invierno y Primavera', 'http://www.frutasiru.com/uploads/news/1[11].jpg', 1),
(24, 'Granada', 'Punica granatum', '3 a 5 meses ', 'Verano - Invierno', 'http://luisguillermodigital.com/wp-content/uploads/2015/02/granada-fruta.jpg', 1),
(25, 'Limon', 'Citrus limonum', 'Como bastante', 'Casi todo las epocas', 'http://abc.miled.com/wp-content/uploads/2015/04/1091635_76300344.jpeg', 1),
(26, 'Mamey colorado', 'Calocarpum mammosum', '4 - 8 meses', 'Verano - Invierno', 'http://www.floridahillnursery.com/images/Mamey%20Sapote%20.jpeg.jpg', 1),
(27, 'Mandarina', 'Citrus retriculata', '5 - 6 meses', 'Invierno - Verano', 'http://www.rawperu.com/wp-content/uploads/2014/12/mandarina.jpg', 1),
(28, 'Mango', 'Mangifera indica', '6 - 8 meses', 'Casi todas las epocas', 'http://www.trops.es/wp-content/uploads/2014/10/mango-lg2.jpg', 1),
(29, 'Maracuya / Pasionaria', 'Passiflora laurifolia', '3 - 7 meses', 'Casi todas las epocas', 'http://versveld.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/m/a/maracuya.jpg', 1),
(30, 'Melon de agua', 'Citrullus vulgaris', '3 - 5 meses', 'Verano - Invierno', 'http://imagenes.lacocinademama.net/recetas/232.jpg', 1),
(31, 'Naranja agria', 'Citrus aurantium', '3 - 5 meses', 'Verano - Invierno', 'http://plantas-especies.com/wp-content/uploads/2012/11/NARANJA-AGRIA.jpg', 1),
(32, 'Naranja dulce', 'Citrus sinensis', '3 - 5 meses', 'Verano - Invierno', 'http://cuantas-calorias.org/wp-content/uploads/2015/01/calorias-de-la-naranja.jpg', 1),
(33, 'Banano / Gineo', 'Musa paradidisiaca', '3 - 6 meses', 'Verano - Invierno', 'http://descubreelpoderdecomersano.com/wp-content/uploads/2013/09/Siete-beneficios-de-comer-banano-en-tu-dieta-diaria%E2%80%A6.jpg', 1),
(34, 'Platano', 'Musa balsisiana', '4 - 6 meses', 'Verano - Invierno', 'http://2.bp.blogspot.com/_IkMcpLFV_cQ/TFrGf6OC4wI/AAAAAAAAAGw/dRznHjTI1bs/s1600/platanos.gif', 1),
(35, 'Toronja', 'Citrus paradisi', '5 - 7 meses', 'Verano - Invierno', 'http://aromasparaelalma.files.wordpress.com/2010/01/toronja-large4.jpg', 1),
(36, 'Uvas', 'Vitris vinifera', '3 - 5 meses', 'Verano', 'http://www.fundaciondelcorazon.com/images/stories/corazon-facil/impulso-vital/uvas.jpg', 1),
(37, 'Arroz', 'Oryza satina', '6 - 8 meses', 'Casi todas las epocas', 'http://ejerciciosencasa.es/wp-content/uploads/2013/11/arroz.jpg', 1),
(38, 'Papa / Patata', 'Solanum tuberosum', '65 -  100', 'Primavera', 'http://madresconectadas.com/wp-content/uploads/2014/04/papas.jpg', 1),
(39, 'Yuca / Mandioca', 'Manihot esculenta Crantz', '4 meses en adelante', 'Casi todas las epocas', 'http://autoserviciomercatodo.com/wp-content/uploads/2012/03/yuca.jpg', 1),
(40, 'Frijol negro', 'Phaleolus spp', '3 - 5 meses', 'Verano - Invierno', 'http://www.mx.all.biz/img/mx/catalog/42045.png', 1),
(41, 'Esparrago', 'Asparagus officinalis', '65 - 100 dias', 'Verano -Invierno', 'http://blogquieroeco.files.wordpress.com/2013/11/esparrago-quieroeco.jpg', 1),
(42, 'Girasol', 'Helianthus annuuns', '11 - 12 meses', 'Casi todas las epocas', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgpb5gAB56obtwU_V8dby08zA1ZOyzuz9HpAo4yqwDX4TspcA6fA', 1),
(43, 'Rosa', 'Rosa', '6 -9 meses', 'Verano - Primavera', 'http://elblog.artim.ca/wp-content/uploads/2012/12/Rosa.jpg', 1),
(44, 'Anis', 'Pimpinella asisum', '1 - 3 meses', 'Verano - Invierno', 'http://www.gastronomiaycia.com/wp-content/uploads/2008/08/anis_estrellado.jpg', 1),
(45, 'Manzanilla', 'Chysantellum americanum', ' 1 - 3 meses ', 'Verano - Invierno', 'http://www.tujardinmedicinal.com/media/blog/flores-de-manzanilla.jpg', 1),
(46, 'Oreganos', 'Hyptis suaveolens', '4- 6 meses', 'Verano - Invierno', 'http://www.cl.all.biz/img/cl/catalog/11096.jpeg', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `plantas_pestes`
--

CREATE TABLE IF NOT EXISTS `plantas_pestes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Plantas_id` int(11) NOT NULL,
  `Pestes_id` int(11) NOT NULL,
  `Pesticidas_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_Plantas_pestes_Plantas1_idx` (`Plantas_id`),
  KEY `fk_Plantas_pestes_Pestes1_idx` (`Pestes_id`),
  KEY `fk_Plantas_pestes_Pesticidas1_idx` (`Pesticidas_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;

--
-- Volcado de datos para la tabla `plantas_pestes`
--

INSERT INTO `plantas_pestes` (`id`, `Plantas_id`, `Pestes_id`, `Pesticidas_id`) VALUES
(1, 1, 4, 2),
(2, 1, 1, 1),
(3, 1, 6, 23),
(4, 1, 64, 50);
...
INSERT INTO `tablas` (`id`, `descripcion`) VALUES
(1, 'Plantas'),
(2, 'Pesticidas');
...
INSERT INTO `usuarios` (`id`, `nick`, `email`, `password`, `tipo`, `nombre`, `apellido`) VALUES
(1, 'ljalca', 'luiggi.jalca@outlook.com', '123456', '1', 'Luiggi Alexander', 'Jalca');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `usuario_skill`
--

CREATE TABLE IF NOT EXISTS `usuario_skill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Usuarios_id` int(11) NOT NULL,
  `padre_skill` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_usuario_skill_Usuarios_idx` (`Usuarios_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Filtros para la tabla `catastrofes`
--
ALTER TABLE `catastrofes`
  ADD CONSTRAINT `fk_Catastrofes_Cultivo1` FOREIGN KEY (`Cultivo_id`) REFERENCES `cultivo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Catastrofes_Plantas_pestes1` FOREIGN KEY (`Plantas_pestes_id`) REFERENCES `plantas_pestes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `cultivo`
--
ALTER TABLE `cultivo`
  ADD CONSTRAINT `fk_Cultivo_City1` FOREIGN KEY (`City_id`) REFERENCES `city` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Cultivo_Plantas1` FOREIGN KEY (`Plantas_id`) REFERENCES `plantas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Cultivo_Usuarios1` FOREIGN KEY (`Usuarios_id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detalle_catalogo`
--
ALTER TABLE `detalle_catalogo`
  ADD CONSTRAINT `fk_Detalle_Catalogo_Catalogo1` FOREIGN KEY (`Catalogo_id`) REFERENCES `catalogo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `notas`
--
ALTER TABLE `notas`
  ADD CONSTRAINT `fk_Notas_tablas1` FOREIGN KEY (`tablas_id`) REFERENCES `tablas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `plantas_pestes`
--
ALTER TABLE `plantas_pestes`
  ADD CONSTRAINT `fk_Plantas_pestes_Pestes1` FOREIGN KEY (`Pestes_id`) REFERENCES `pestes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Plantas_pestes_Pesticidas1` FOREIGN KEY (`Pesticidas_id`) REFERENCES `pesticidas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Plantas_pestes_Plantas1` FOREIGN KEY (`Plantas_id`) REFERENCES `plantas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `usuario_skill`
--
ALTER TABLE `usuario_skill`
  ADD CONSTRAINT `fk_usuario_skill_Usuarios` FOREIGN KEY (`Usuarios_id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

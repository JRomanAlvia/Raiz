...
public function actionView($id)
{
    ...
    $modeloPlantasPestes= new PlantasPestes;
            $modeloPlantasPestes->Plantas_id= $id;          
            if (isset($_POST['PlantasPestes'])) {
                $modeloPlantasPestes->attributes=$_POST['PlantasPestes'];               
                if ($modeloPlantasPestes->save()) {
...
'modeloPlantasPestes'=>$modeloPlantasPestes,
));
}
